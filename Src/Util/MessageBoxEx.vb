...
Public Class MessageBoxEx
    ...
    Public Shared Function Show(text As String, caption As String, buttons As MessageBoxButtons, Optional buttonTitles() As String = Nothing)
        ...
        Dim result As DialogResult = MessageBox.Show(frm, text, caption, buttons)
        frm.Close()
        Return result
    End Function

    Public Shared Function Show(text As String, caption As String, buttons As MessageBoxButtons, _
                                icon As MessageBoxIcon, defaultButton As MessageBoxDefaultButton, Optional buttonTitles() As String = Nothing)
        Dim frm As New MessageForm(buttons, buttonTitles)
        frm.Show()
        frm.WatchForActivate = True
    ...
    Class MessageForm
        ...
        Private _DlgFont As New Font("Microsoft YaHei UI", SystemFonts.DefaultFont.Size)
